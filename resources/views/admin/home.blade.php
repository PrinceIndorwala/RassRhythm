...
<html>
  <head> 
    ...
    <!-- Favicon-->
    <!-- <link rel="shortcut icon" href="{{asset('admin-custom/img/favicon.ico')}}"> -->
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            <!-- Navbar Header--><a href="index.html" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Rass</strong><strong>Rhythm</strong></div>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          ...
          <div class="title">
            <h1 class="h5">RassRhythm Admin</h1>
            <p>Web Designer</p>
          </div>
        </div>
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="{{ route('admin.overview') }}"> <i class="icon-grid"></i>Users </a></li>
                <li><a href="charts.html"> <i class="fa fa-bar-chart"></i>Students </a></li>
                <li><a href="forms.html"> <i class="icon-padnote"></i>Feedbacks </a></li>
                <li><a href="{{route('admin.galleryy')}}">Gallery </a></li>
                <li><a href="{{ route('admin.video') }}">Videos </a></li>
